...
class block_users_courses extends block_base {
    ...
    // public function get_content() {
        ...
        // // Paginación
        // $baseurl = new moodle_url('/blocks/users_courses/block_users_courses.php', array('id' => $this->instance->id)); 
        // $baseurl = new moodle_url('/blocks/users_courses/block_users_courses.php', array('id' => $PAGE->context->instanceid));
        // $this->content->text .= $OUTPUT->paging_bar($totalusers, $page, $perpage, $baseurl);
